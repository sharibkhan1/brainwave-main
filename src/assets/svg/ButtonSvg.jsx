const ButtonSvg = ({ white, hiddenOnHover }) => (
  <>
    <svg
      className={`absolute top-0 left-0 transition-opacity duration-300 ${hiddenOnHover ? 'opacity-0' : 'opacity-100'}`}
      width="21"
      height="44"
      viewBox="0 0 21 44"
    >
    ...
    <svg
      className={`absolute top-0 left-[1.3125rem] w-[calc(100%-2.625rem)] transition-opacity duration-300 ${hiddenOnHover ? 'opacity-0' : 'opacity-100'}`}
      height="44"
      viewBox="0 0 100 44"
    ...
    <svg
      className={`absolute top-0 right-0 transition-opacity duration-300 ${hiddenOnHover ? 'opacity-0' : 'opacity-100'}`}
      width="21"
      height="44"
      viewBox="0 0 21 44"
    >
